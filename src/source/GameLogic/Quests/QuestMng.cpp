...
bool CQuestMng::GetRequestRewardText(SRequestRewardText* aDest, int nDestCount, DWORD dwQuestIndex)
{
    ...
    for (i = 0; i < pRequestReward->m_byRequestCount; ++i, ++nLine)
    {
        ...
        case QUEST_REQUEST_PVP_POINT:
            ...
            {
            case QUEST_REQUEST_MONSTER:
                ::mu_swprintf(aDest[nLine].m_szText, I18N::Game::QuestMonsterProgress,
            ...
            case QUEST_REQUEST_ITEM:
            {
                ...
                ::mu_swprintf(aDest[nLine].m_szText, I18N::Game::QuestItemProgress, szItemName,
                    MIN(pRequestInfo->m_dwCurValue, pRequestInfo->m_dwValue),
                    pRequestInfo->m_dwValue);
            }
            break;
            case QUEST_REQUEST_LEVEL:
                ::mu_swprintf(aDest[nLine].m_szText, I18N::Game::QuestRequiredLevel,
                    pRequestInfo->m_dwValue, I18N::Game::Minimum);
                break;
            case QUEST_REQUEST_ZEN:
                ::mu_swprintf(aDest[nLine].m_szText, I18N::Game::QuestRequiredZen, pRequestInfo->m_dwValue);
                break;
            case QUEST_REQUEST_PVP_POINT:
        ...
        case QUEST_REQUEST_SKILL:
            ...
            ::mu_swprintf(aDest[nLine].m_szText, I18N::Game::QuestRequiredSkill,
        ...
        case QUEST_REQUEST_BUFF:
        {
            ...
            ::mu_swprintf(aDest[nLine].m_szText, I18N::Game::QuestRequiredBonus, buffinfo.s_BuffName);
        }
        break;
    ...
    for (j = 0; j < 2; ++j)
    {
        ...
        for (; i < byRewardCount; ++i, ++nLine)
        {
            ...
            case QUEST_REWARD_EXP:
                ::mu_swprintf(aDest[nLine].m_szText, I18N::Game::QuestRewardExperience, pRewardInfo->m_dwValue);
                break;
            ...
            case QUEST_REWARD_BUFF:
            {
                ...
                ::mu_swprintf(aDest[nLine].m_szText, I18N::Game::QuestRewardBonus, buffinfo.s_BuffName,
